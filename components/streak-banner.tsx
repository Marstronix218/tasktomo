...
export default function StreakBanner({
  ...
  if (atRisk) {
    return (
      <Card className="bg-gradient-to-r from-orange-900/40 to-red-900/30 border-orange-500/40 text-orange-950 mb-6">
        <CardContent className="p-4 flex items-center gap-3 flex-wrap">
          ...
          {streakFreezes > 0 ? (
            ...
            <Link href="/pricing">
              <Button size="sm" variant="outline" className="border-orange-500/50 text-orange-950 bg-transparent hover:bg-orange-900/10">
                Get freezes (Premium)
              </Button>
            </Link>
          ) : null}
  ...
  if (streakCount >= 3 && safe) {
    return (
      <Card className="bg-gradient-to-r from-orange-900/30 to-yellow-900/20 border-orange-500/30 text-orange-950 mb-6">
        <CardContent className="p-4 flex items-center gap-3 flex-wrap">
          ...
          {streakFreezes > 0 && (
            <Badge variant="outline" className="border-blue-500/40 text-blue-900">
